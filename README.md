...
FTB Promoter is a simple, client-only, mod designed to provide, clean and unobtrusive, in-game promotions for our server providers.

## Features

- Server List Promotion entry in the Multiplayer Join Screen
- FancyMenu Integration
- Customizable Promotions via our API
